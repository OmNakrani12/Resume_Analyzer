...
/**
 * AI-powered Risk Analysis using Groq
 * @param {string} text - Resume text
 * @returns {Object} AI Risk analysis results
 */
export async function analyzeRiskAI(text) {
    ...
    const prompt = `
You are an expert fraud investigator and resume auditor.
Analyze the following resume text for potential risks, exaggerations, or fake project claims.
...
/**
 * Analyze resume text for risk indicators (Rule-based)
...
export async function analyzeRisk(text, context = {}) {
    try {
        ...
        return {
            ...
            red_flags: redFlags.sort((a, b) => b.impact - a.impact),
            recommendations,
            detailed_analysis: {
