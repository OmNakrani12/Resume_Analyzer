...
export const userAPI = {
  // Get user profile
  getProfile: (userId) => api.get(`/profile?userId=${userId}`),
...
export const resumeAPI = {
  ...
  // Get specific resume
  getDetail: (resumeId) => api.get(`/resumes/${resumeId}`),
...
// ==================== DIRECT PYTHON API (for special cases) ====================
export const pythonAPI = {
  baseURL: PYTHON_API_URL,

  // Direct analyze (bypassing Next.js)
  analyzeDirectly: async (file) => {
    const formData = new FormData();
    formData.append('file', file);
